...
cat ${ROOT_DIR}/parameters/dev-app-service | xargs aws cloudformation deploy --template-file ${ROOT_DIR}/cloudformation/app-stack.cf.yaml --capabilities CAPABILITY_IAM